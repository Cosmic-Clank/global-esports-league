		...
		<section id='description' className='mx-auto max-w-6xl px-6 py-12'>
			<div className='flex flex-col-reverse md:flex-col gap-8'>
				<FadeRight>
					...
					<CustomButton href='/league' text='Tournamet Formatting and rules' />
				</FadeRight>

				<FadeLeft className='flex items-center justify-center'>
					<div className='w-full h-full rounded-md overflow-hidden'>
						<Image src='/images/infographic.png' alt='GEL Infographic' width={512} height={256} className='object-cover md:w-3/4 md:h-3/4 w-full h-full mx-auto' />
					</div>
				</FadeLeft>
			</div>
		</section>
